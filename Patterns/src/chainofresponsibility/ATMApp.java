...
class Money {
    ...
    public void setAmt(int amt) {
        if (amt > 0 && amt <= 200_000 && amt % Note.R100 == 0) {
            ...
            throw new RuntimeException("Sum of money can't be more than 200 000 and should be multiple for 100");
        }
    }
}
...
class NoteModule5000 extends NoteModule {
    ...
    void takeMoney(Money money) {
        ...
        if (countNote > 0) {
            System.out.println("Issued " + countNote + " bills of denomination " + Note.R5000);
        }
...
class NoteModule1000 extends NoteModule {
    ...
    void takeMoney(Money money) {
        ...
        if (countNote > 0) {
            System.out.println("Issued " + countNote + " bills of denomination " + Note.R1000);
        }
        if(remind > 0 && next != null) {
            next.takeMoney(new Money(remind));
        }
...
class NoteModule500 extends NoteModule {
    ...
    void takeMoney(Money money) {
        ...
        if (countNote > 0) {
            System.out.println("Issued " + countNote + " bills of denomination " + Note.R500);
        }
        if(remind > 0 && next != null) {
            next.takeMoney(new Money(remind));
        }
...
class NoteModule100 extends NoteModule {
    ...
    void takeMoney(Money money) {
        ...
        if (countNote > 0) {
            System.out.println("Issued " + countNote + " bills of denomination " + Note.R100);
        }
        if(remind > 0 && next != null) {
            next.takeMoney(new Money(remind));
        }
